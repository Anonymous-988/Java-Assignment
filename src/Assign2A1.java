...
class Assign2A1 extends JFrame implements ActionListener
{
    JLabel l1,l2,l3;
    JTextField t1,t2,t3;
    JButton b1,b2,b3;
    ...
    public void actionPerformed(ActionEvent e)
    {
        if((JButton)b1==e.getSource())
        {
            ...
            try
            {
                ...
                con=DriverManager.getConnection("jdbc:postgresql://192.168.100.254/Bill","password","password");
        ...
        else if((JButton)b2==e.getSource())
        {
            ...
            {
                Class.forName("org.postgresql.Driver");
                con=DriverManager.getConnection("jdbc:postgresql://localhost:5432/","oracle","oracle");
